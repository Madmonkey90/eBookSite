...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="69.121.220.130:8084/eLibrary/details${currentBook.key}" />
  ...
  <body>
    ...
    <jsp:include page="common/toolbar.jsp"/>
      <div class="container">
          <img src="${fn:replace(currentBook.imgSrc,"225x225-75.jpg","600x600-75.jpg")}" align="left" style="margin-top: 80px; margin-left:20px; max-height: 600px; max-width: 600px">
            ...
            <span class="buttons" style="margin-left: 15px;">
              ...
              <div id = "ratings"> 
               <form name="ratingForm" action="setRating">
                <input name="rating" type="number" class="rating" min=0 max=5 step=.5 data-size="md" data-show-clear="false">
            ...
            <div class="panel-body"> 
              ...
              <div class="fb-share-button" data-href="https://developers.facebook.com/docs/plugins/" ></div>                            
                 <a href="https://twitter.com/share" class="twitter-share-button" style="padding:24px; margin-top: -10px;">Tweet</a>    
                </div>    
